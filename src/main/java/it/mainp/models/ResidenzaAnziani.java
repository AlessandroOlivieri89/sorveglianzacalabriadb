...
@Entity
@Table (name= "strutture_anziani")
public class ResidenzaAnziani {

	@Id
	@GeneratedValue (strategy= GenerationType.AUTO)
	private long idResidenzaAnziani;
	
	@Column (name = "nome_residenza_anziani")
	private String nome;
	...
	@ManyToOne
	@JoinColumn (name = "anzianiIdComune")
	@JsonBackReference
	private ComuniProvince comuniProvince;
	
	public ResidenzaAnziani() {
		
	}



	public long getIdResidenzaAnziani() {
		return idResidenzaAnziani;
	}
